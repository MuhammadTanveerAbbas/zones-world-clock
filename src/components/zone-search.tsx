...
export function ZoneSearch({
	...
	const results = useMemo(
		() => searchTimezones(debouncedQuery),
		[debouncedQuery],
	);
	...
	}, [onClose, results, selectedIndex, handleAdd]);

	return (
		// biome-ignore lint/a11y/useSemanticElements: custom modal layout with backdrop click-to-close
		<div
			role="dialog"
			aria-modal="true"
